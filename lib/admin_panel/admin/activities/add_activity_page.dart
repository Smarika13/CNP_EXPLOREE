...
class _AddActivityPageState extends State<AddActivityPage> {
  ...
  final domesticController = TextEditingController();
  final saarcController = TextEditingController();
  final touristController = TextEditingController();
  final List<TextEditingController> _slotControllers = [TextEditingController()];
  ...
  Future<String?> _uploadImage(String activityName) async {
    if (_pickedImage == null) return null;
    return await CloudinaryService.uploadImage(_pickedImage!);
  }
          ...
          children: [
                ...
                child: _pickedImage != null
                    ...
                    : Column(
                        ...
                        children: [
                          ...
                          Text('Tap to add activity image',
            ...
            ElevatedButton(
              ...
              child: _saving
                  ...
                  : const Text('Add Activity', style: TextStyle(fontSize: 15)),
            ),
          ],
        ),
      ),
